  ...
  <xsl:template mode="render-field"
    ...
    <dl class="gn-code">
      ...
      <dd>
        ...
        <xsl:value-of select="*/gmd:codeSpace"/>
                
        <xsl:if test="starts-with(normalize-space(*/gmd:codeSpace), 'https://schema.org')">
            <script id="schemaDotOrg" type="application/ld+json">
